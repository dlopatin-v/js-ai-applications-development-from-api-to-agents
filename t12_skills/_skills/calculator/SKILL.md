...
The script is already implemented at scripts/calculate.js — study it to understand what it does.
...
List all supported operations (read calculate.js to discover them):
Arithmetic, Power / exponentiation, Square root, Floor division and modulo operators, Trigonometric functions, Mathematical constants, Grouping with parentheses
